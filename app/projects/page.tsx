  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-6">
        <Topbar title="CTOD Curation Dashboard" subtitle="Demo-first workbench for schema-driven extraction, SME review, and publish-ready output." />
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          <div className="card p-5 lg:col-span-2">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="text-lg font-semibold">Active Projects</h2>
                <p className="mt-1 text-sm text-slate-600">Track configured fields, review queue, and publication readiness.</p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Start with project creation, configure a few CTOD fields, simulate extraction, review values with evidence,
                correct ambiguous fields, and show how captured corrections strengthen the learning loop.
              </p>
            </div>
          </div>
        </div>
